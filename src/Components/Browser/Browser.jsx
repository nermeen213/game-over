...
export default function Browser() {
   ...
   async function getbrowsergames(browser){
    try {
        let{data}=await getPcGames(browser)
    ...
    return (
        ...
        <div className="row g-4 ">
            {browserGames?.map((game,indx)=><div key={indx} className="col-lg-3 col-md-6">
